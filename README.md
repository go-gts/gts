...
```sh
# 32 bit with wget
$ wget https://github.com/go-gts/gts/releases/download/v0.26.9/gts_0.26.9_linux_386.deb
# 32 bit with curl
$ curl -LO https://github.com/go-gts/gts/releases/download/v0.26.9/gts_0.26.9_linux_386.deb
# 64 bit with wget
$ wget https://github.com/go-gts/gts/releases/download/v0.26.9/gts_0.26.9_linux_amd64.deb
# 64 bit with curl
$ curl -LO https://github.com/go-gts/gts/releases/download/v0.26.9/gts_0.26.9_linux_amd64.deb
```

2. Install the deb package with dpkg.
```sh
# 32 bit
$ dpkg --install gts_0.26.9_linux_386.deb
# 64 bit
$ dpkg --install gts_0.26.9_linux_amd64.deb
```

3. Remove the deb package file.
```sh
# 32 bit
$ rm gts_0.26.9_linux_386.deb
# 64 bit
$ rm gts_0.26.9_linux_amd64.deb
```

#### With yum
```sh
# 32 bit
$ yum install -y https://github.com/go-gts/gts/releases/download/v0.26.9/gts_0.26.9_linux_386.rpm
# 64 bit
$ yum install -y https://github.com/go-gts/gts/releases/download/v0.26.9/gts_0.26.9_linux_amd64.rpm
```
...
- https://github.com/go-gts/gts/releases/download/v0.26.9/gts-completion.bash
- https://github.com/go-gts/gts/releases/download/v0.26.9/gts-completion.zsh
